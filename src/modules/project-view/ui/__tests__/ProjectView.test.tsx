...
vi.mock("@/modules/project-view/ui/components/dialogs/RemoveFileDialog", () => ({
  RemoveFileDialog: ({
    open,
    onOpenChange,
    onConfirm,
...
import { ProjectView } from "@/modules/project-view/ui/ProjectView";
...
describe("ProjectView", () => {
  it("renders files and conversion badges", async () => {
    ...
    renderWithProviders(<ProjectView projectSummary={projectSummary} />);
