...
export const PHONE_COUNTRY_CODES = getCountries() as CountryCode[];
export const FALLBACK_PHONE_COUNTRY: CountryCode = PHONE_COUNTRY_CODES.includes("US" as CountryCode)
  ? ("US" as CountryCode)
...
export function resolveDefaultCountry(): CountryCode {
  if (typeof navigator !== "undefined" && navigator.language) {
    ...
    if (region) {
      ...
      if (PHONE_COUNTRY_CODES.includes(upper as CountryCode)) {
