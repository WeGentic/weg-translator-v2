import { Clock, FileText, Languages, ZapOff } from "lucide-react";
import { Badge } from "@/shared/ui/badge";
import type { ProjectDetails, ProjectListItem } from "@/core/ipc";
    ...
    <div className="mx-4 rounded-xl border border-border/40 bg-gradient-to-br from-background/95 via-background/90 to-background/95 p-4 shadow-sm">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          {!autoConvertOnOpen ? (
            <Badge variant="outline" className="gap-1 text-[0.65rem] uppercase">
