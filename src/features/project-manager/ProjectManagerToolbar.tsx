...
import { DatePreset, ProgressFilter, TableFilters, TypeFilter } from './types/types';

export interface ProjectsManagerToolbarProps {
  search: string;
...
export function ProjectsManagerToolbar({
  ...
  const hasActiveFilters = useMemo(() => {
    return (
      filters.progress !== 'all' || filters.projectType !== 'all' || filters.updatedWithin !== 'any'
    );
  }, [filters]);
          ...
          <div className='hidden lg:flex items-center gap-2'>
            <div className='flex items-center gap-1.5'>
              <Select
                ...
                onValueChange={(v) => setProgress(v as ProgressFilter)}
              >
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant='outline'
                  size='sm'
                  className='h-9 border-border/50 bg-background/60 relative px-3 transition-all duration-200 hover:bg-background/80 hover:border-border/70'
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='space-y-1.5'>
                      ...
                      <Select
                        ...
                        onValueChange={(v) => setDate(v as DatePreset)}
                      >
                        <SelectTrigger className='h-8 text-sm'>
                          <SelectValue />
                        </SelectTrigger>
