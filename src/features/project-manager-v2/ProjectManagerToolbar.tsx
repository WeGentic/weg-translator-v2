          ...
          <div className="group relative flex-1 max-w-sm">
            ...
            {search ? (
              <button
                ...
                className="absolute right-2 top-1/2 flex h-5 w-5 -translate-y-1/2 items-center justify-center rounded-full bg-muted/60 opacity-0 transition-all duration-200 hover:bg-muted/80 focus-visible:opacity-100 group-hover:opacity-100"
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="relative h-9 px-3 border-border/50 bg-background/60 transition-all duration-200 hover:bg-background/80 hover:border-border/70"
