...
import { ProjectsManagerHeader } from "../project-manager/ProjectManagerHeader";
import { ProjectsManagerToolbar } from "./ProjectManagerToolbar";
import { ProjectManagerContent } from "./ProjectManagerContent";
import { EmptyProjectsState } from "../project-manager/components/EmptyProjectsState";
import { CreateProjectWizard } from "../project-manager/components/wizard/CreateProjectWizard";
import { DeleteProjectDialog } from "../project-manager/components/DeleteProjectDialog";
import { useSidebarTwoContentSync } from "../project-manager/hooks/useSidebarTwoContentSync";
import {
